...
(
    `id`                       number(20) NOT NULL COMMENT 'key',
    `name`                     varchar(255) NOT NULL COMMENT 'config name',
    `status`                 varchar(255)  COMMENT '',
    `description`            varchar(1023) COMMENT '',

    `create_time`              datetime     COMMENT 'create time',
    `create_user`              varchar(255) COMMENT 'create user',
    `modify_time`              datetime     COMMENT 'modify time',
    `modify_user`              varchar(255) COMMENT 'modify user',
    PRIMARY KEY (`id`)
);
